...
if __name__ == '__main__':
    ...
    keypoints_scoremap_tf, image_crop_tf, scale_crop_tf, center_tf = net.inference2d(image_tf)
    ...
    for img_name in image_list:
        ...
        # 2D pipeline
        keypoints_scoremap_v, image_crop_v, scale_v, center_v = sess.run([keypoints_scoremap_tf, image_crop_tf, scale_crop_tf, center_tf], feed_dict={image_tf: image_v})
